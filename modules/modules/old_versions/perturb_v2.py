...
from modules.util import contains_isolates,remove_edges, sample_nodes


def randomly_perturb(G: nx.Graph, data: torch_geometric.data.data.Data,  add: int=0, remove: int=0) -> nx.Graph:
    ...
    while True:
        ...
        if remove != 0:
            ...
            edges_to_remove, Gp, edge_index = remove_edges(Gp, data, remove)
        else:
            perturb_type = 'add'
